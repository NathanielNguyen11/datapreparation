...
import sys
import argparse
# IMDIR = '/home/ubuntu/Desktop/ashole_data/2/image'
# LBDIR = '/home/ubuntu/Desktop/ashole_data/2/label'

IMDIR = '/media/ubuntu/Quang/challenge/liver/CHAOS/CT/experi/train/300x3001/image'
LBDIR = '/media/ubuntu/Quang/challenge/liver/CHAOS/CT/experi/train/300x3001/label'
cropsizeh=230
cropsizew=230
...
def main(args):
	...
	height_crop = cropsizeh
	weight_crop = cropsizew
	for image in images:
